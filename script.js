...
document.getElementById("siBtn").addEventListener("click", function () {
  ...
  document.getElementById("messageContainer").innerHTML =
    "Chiii, te amo con todo mi corazón";
...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    ...
    case 1:
      ...
      document.getElementById("noBtn").innerHTML = "¡¿En serio estás segura?!";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      document.getElementById("sadGifContainer").style.display = "none";
    ...
    case 3:
      document.getElementById("noBtn").innerHTML = "¿Positivo?";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      ...
      break;
    case 4:
      document.getElementById("noBtn").innerHTML = "Decí que sí por favor";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      ...
      break;
    case 5:
      document.getElementById("noBtn").innerHTML = "Pensalo bien";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 6:
      document.getElementById("noBtn").innerHTML =
        "Si decís que no voy a estar muy triste";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 9:
      document.getElementById("noBtn").innerHTML =
        "Voy a estar muy muy muy muy triste.";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 10:
      ...
      break;
    case 11:
      document.getElementById("noBtn").innerHTML = "POR FAVOR DECÍ SÍ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 12:
      document.getElementById("noBtn").innerHTML =
        "Voy a estar muy muy muy muy muy triste.";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 14:
      document.getElementById("noBtn").innerHTML = "Ya decí que sí";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 15:
      document.getElementById("noBtn").innerHTML = "Daleeeeeeeeeeeeeeeeeee";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
